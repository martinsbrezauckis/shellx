...
//!
//! Built from the original external prototype and ported into the
...
impl GoalOrchestrator {
 ...
 ## Phase N — Complete\n\
    ...
    pub async fn consider_continue(&self, tab_id: &str, stop_reason: &str) -> Option<String> {
        ...
        // Phase 2: stopReason gate. Match the legacy continuation rule:
...
/// lived in the external prototype, but production behavior here now
