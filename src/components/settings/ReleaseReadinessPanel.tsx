...
import "./ReleaseReadinessPanel.css";
import {
  buildReleaseRunbook,
  ...
  const releaseChecks = useMemo(
    () =>
      buildReleaseReadinessChecks({
        ...
        providerCapabilitySnapshotVerified: !!releaseDone["provider-capability-snapshot"],
        debugApiSurfaceSweepVerified: !!releaseDone["debug-api-surface-sweep"],
        shellxBrowserDebugApiVerified: !!releaseDone["shellx-browser-debug-api"],
        tauriWebdriverVerified: !!releaseDone["tauri-webdriver"],
        previewQaStudioVerified: !!releaseDone["preview-qa-studio"],
        ...
        updaterManifest: !!releaseDone["updater-manifest"],
