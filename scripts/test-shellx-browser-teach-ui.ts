...
check(component.includes('data-debug-id="shellx-browser-teach-save-draft"') && component.includes('data-debug-id="shellx-browser-teach-rehearse"') && component.includes('data-debug-id="shellx-browser-teach-approve-recipe"'), "provides stable selectors for Save, dry-run Rehearse, and explicit approval");
