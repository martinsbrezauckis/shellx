...
export const BROWSER_TEACH_CONTROL_SURFACE_IDS = new Set([
  ...
  'ui-control:src/browser/components/BrowserTeachReview.tsx:[data-debug-id="shellx-browser-teach-copy-approval-receipt"]@src/browser/components/BrowserTeachReview.tsx#12',
  'ui-control:src/browser/components/BrowserTeachReview.tsx:[data-debug-id="shellx-browser-teach-copy-rehearsal-receipt"]@src/browser/components/BrowserTeachReview.tsx#13',
  'ui-control:src/browser/components/BrowserTeachReview.tsx:[data-debug-id="shellx-browser-teach-copy-task-receipt"]@src/browser/components/BrowserTeachReview.tsx#14',
  'ui-control:src/browser/components/BrowserTeachReview.tsx:[data-debug-id="shellx-browser-teach-create-task"]@src/browser/components/BrowserTeachReview.tsx#11',
...
export const BROWSER_TEACH_DEBUG_ASSIGNMENT_IDS = new Set([
  ...
  "ui-debug-surface:shellx-browser-teach-approval-receipt@src/browser/components/BrowserTeachReview.tsx#25",
  ...
  "ui-debug-surface:shellx-browser-teach-copy-approval-receipt@src/browser/components/BrowserTeachReview.tsx#26",
  "ui-debug-surface:shellx-browser-teach-copy-rehearsal-receipt@src/browser/components/BrowserTeachReview.tsx#28",
  "ui-debug-surface:shellx-browser-teach-copy-task-receipt@src/browser/components/BrowserTeachReview.tsx#30",
  "ui-debug-surface:shellx-browser-teach-create-task@src/browser/components/BrowserTeachReview.tsx#24",
  ...
  "ui-debug-surface:shellx-browser-teach-rehearsal-receipt@src/browser/components/BrowserTeachReview.tsx#27",
  "ui-debug-surface:shellx-browser-teach-task-handoff-receipt@src/browser/components/BrowserTeachReview.tsx#29",
...
export const BROWSER_TEACH_DEBUG_SURFACE_IDS = new Set([
  ...
  "shellx-browser-teach-copy-task-receipt", "shellx-browser-teach-create-task",
  ...
  "shellx-browser-teach-vault-unavailable", "shellx-browser-teach-task-handoff-receipt",
]);
