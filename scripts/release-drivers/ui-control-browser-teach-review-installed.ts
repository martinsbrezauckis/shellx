...
const manifest: ReleaseSurfaceDriverManifest = {
  ...
  id: "ui-control-browser-teach-review-installed",
  kind: "ui-control",
  ...
  supportedOracles: [...BROWSER_TEACH_INSTALLED_CONTROL_ORACLES],
};
...
async function execute(request: ReleaseSurfaceDriverRequest): Promise<ReleaseSurfaceDriverReport> {
  ...
  return {
    ...
    outcomes: browserTeachControlOutcomes(request.assignments, proof),
  };
}
