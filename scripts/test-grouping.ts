 ...
 *
 * Deterministic regression checks for the event-to-chat grouping layer.
 * These fixtures are synthetic and sanitized so the public test contract
 * never depends on private capture evidence being present on one machine.
 *
