...
const LEGACY_CEILINGS = new Map([
  ...
  ["src-tauri/src/shellx_browser_action_results.rs", { max: 1_207, target: 1_000 }],
  ["src-tauri/src/shellx_browser_actions.rs", { max: 1_350, target: 1_000 }],
  ...
  ["[retired maintainer tool]", { max: 2_724, target: 1_000 }],
]);
