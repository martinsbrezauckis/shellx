...
const LEGACY_CEILINGS = new Map([
  ...
  ["scripts/test-shellx-browser.ts", { max: 1_000, target: 1_000 }],
  ["scripts/shellx-browser-contract/context.ts", { max: 1_000, target: 1_000 }],
  ["scripts/shellx-browser-contract/native-and-policy.ts", { max: 1_000, target: 1_000 }],
  ["scripts/shellx-browser-contract/debug-and-ui.ts", { max: 1_000, target: 1_000 }],
  ["scripts/shellx-browser-contract/workflows-and-docs.ts", { max: 1_000, target: 1_000 }],
]);
