...
assert(gitRepoScopeLabel(status) === "session cwd", "cwd-scoped repo label stays compact");

const nestedStatus: GitSessionStatus = {
  ...status,
  cwd: "C:\\Users\\FixtureUser\\Downloads",
  repoCwd: "C:\\Users\\FixtureUser\\Downloads\\paint-app",
  repoScope: "singleChildRepo",
  repoCandidates: [{ path: "C:\\Users\\FixtureUser\\Downloads\\paint-app", name: "paint-app" }],
  repoRoot: "C:\\Users\\FixtureUser\\Downloads\\paint-app",
  repoName: "paint-app",
};
assert(gitRepoScopeLabel(nestedStatus) === "nested repo", "single child repo is labeled as nested");
