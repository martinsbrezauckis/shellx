...
assert(
  normalizePreviewReference(
    "C:\\Users\\FixtureUser\\.grok\\sessions\\C%3A%5CUsers%5CFixtureUser%5CDownloads%5CShellX%20improvements\\019e7ace\\images\\1.jpg",
  ) ===
    "C:\\Users\\FixtureUser\\.grok\\sessions\\C%3A%5CUsers%5CFixtureUser%5CDownloads%5CShellX%20improvements\\019e7ace\\images\\1.jpg",
...
assert(
  resolvePreviewPath("./notes.md", "C:\\Users\\FixtureUser\\Documents\\New project 3") ===
    "C:\\Users\\FixtureUser\\Documents\\New project 3\\notes.md",
...
assert(
  resolveSessionMarkdownArtifactPath("C:\\Users\\FixtureUser\\plan.md", {
    cwd: "C:\\Users\\FixtureUser",
    sessionId: "019abc",
  }) === null,
...
assert(
  resolveShellxPreviewScreenshotPath("1780255133125.png", {
    cwd: "C:\\Users\\FixtureUser\\Downloads\\ms-paint-11-api",
    tabId: "tab-5a31awfu",
  }) ===
    "C:\\Users\\FixtureUser\\.grok\\shellx-preview-screenshots\\work-preview-tab-5a31awfu-1780255133125.png",
  "bare Preview Doctor screenshot links resolve to the active Windows screenshot artifact",
);
assert(
  resolveShellxPreviewScreenshotPath("1780255133125.png", {
    cwd: "/home/user/project",
    tabId: "tab-5a31awfu",
  }) === "/home/user/.grok/shellx-preview-screenshots/work-preview-tab-5a31awfu-1780255133125.png",
  "bare Preview Doctor screenshot links resolve to the active POSIX screenshot artifact",
);
assert(
  resolveShellxPreviewScreenshotPath("paint-output.png", {
    cwd: "C:\\Users\\FixtureUser\\Downloads\\ms-paint-11-api",
    tabId: "tab-5a31awfu",
  }) === null,
  "normal bare image links keep resolving against cwd",
);
assert(previewPathHasParentTraversal("../secret.txt"), "parent traversal is blocked");
assert(!previewPathHasParentTraversal("C:\\Users\\FixtureUser\\Documents\\page.html"), "normal Windows paths are allowed");

const htmlRoute = resolvePreviewRoute({
  path: "page.html",
  cwd: "C:\\Users\\FixtureUser\\Documents\\New project 3",
...
assert(
  htmlRoute.ok &&
    htmlRoute.workRoot === "C:\\Users\\FixtureUser\\Documents\\New project 3" &&
...
const tildeMarkdownRoute = resolvePreviewRoute({
  path: "~/shellx-sample/sample.md",
  cwd: "/Users/alice/project",
  canRunWorkPreview: true,
});
assert(
  tildeMarkdownRoute.ok &&
    tildeMarkdownRoute.path === "/Users/alice/shellx-sample/sample.md",
  "tilde markdown paths expand against the active POSIX session home",
);

const externalMarkdownRoute = resolvePreviewRoute({
  path: "D:\\Reference\\plan.md",
  cwd: "C:\\Users\\FixtureUser\\Downloads\\paint-app",
  canRunWorkPreview: true,
});
assert(
  externalMarkdownRoute.ok &&
    externalMarkdownRoute.view === "file" &&
    externalMarkdownRoute.path === "D:\\Reference\\plan.md",
  "absolute markdown previews stay independent of the active project root",
);

const externalHtmlRoute = resolvePreviewRoute({
  path: "D:\\Reference\\demo.html",
  cwd: "C:\\Users\\FixtureUser\\Downloads\\paint-app",
  canRunWorkPreview: true,
});
assert(
  externalHtmlRoute.ok &&
    externalHtmlRoute.view === "work" &&
    externalHtmlRoute.workRoot === "D:\\Reference",
  "absolute HTML Work Preview uses the file parent, not the active project root",
);
